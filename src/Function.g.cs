...
namespace OneMesh
{
    public class Function
    {
        ...
        private UrlModelStore<OneMeshInputs> store;

        public async Task<OneMeshOutputs> Handler(OneMeshInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<OneMeshInputs>();
            }
            

            var l = new InvocationWrapper<OneMeshInputs,OneMeshOutputs> (store, OneMesh.Execute);
